...
export const LeftSidebar: React.FC<ILeftSidebarProps> = (props) => {
  ...
  return mergeClassAndStyleProps(
    props,
    <section className="w-fit background-light900_dark200 light-border sticky left-0 top-0 flex h-screen flex-col justify-between overflow-y-auto border-r p-6 pt-36 shadow-light-300 dark:shadow-none lg:w-[266px] custom-scrollbar">
